...
The repository is designed to be reproducible across systems. All internal paths are relative, while large external datasets are stored in the EDMOND general data repository [SCENES derivatives](https://doi.org/10.17617/3.NX2H2U). 

An independent CODECHECK review successfully reproduced the outputs generated by this repository. The full certificate is available on [Zenodo](https://doi.org/10.5281/zenodo.21238767).
